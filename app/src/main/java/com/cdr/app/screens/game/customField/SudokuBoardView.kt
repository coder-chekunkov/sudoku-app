package com.cdr.app.screens.game.customField
...
class SudokuBoardView(
    ...
    private var colorLines by Delegates.notNull<Int>()
    ...
    constructor(context: Context, attributeSet: AttributeSet?, defStyleAttr: Int): this(context, attributeSet, defStyleAttr, R.style.DefaultSudokuBoardStyle)
    constructor(context: Context, attributeSet: AttributeSet?) : this(context, attributeSet, R.attr.SudokuBoardStyle)
    ...
    private fun initAttributes(attributesSet: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        val typedArray = context.obtainStyledAttributes(attributesSet, R.styleable.SudokuBoardView, defStyleAttr, defStyleRes)

        colorLines = typedArray.getColor(R.styleable.SudokuBoardView_linesColor, Color.BLACK)
